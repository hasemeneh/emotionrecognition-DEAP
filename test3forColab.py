...
if __name__ == '__main__':
	...
	np.savetxt('drive/My Drive/skripsoy/dataset/data-bandpassed-alpha-beta-gamma-stft-pca.csv', populatedData, delimiter=',')
