...
def populatePart(n):
	...
	for y in xrange(0,40):
		...
		temporalData = vstackX((temporalData,tobeprocessed.T))
		count = count+1
		data = vstackX((data,temporalData.T))
		temporalData = None
		# for x in dataY:
		# 	x = x[:32]
		# 	# print(hitung , "," ,y)
...
if __name__ == '__main__':
	...
	while i<6 :
		...
		print((count/(40*5.0)) , populatedData.shape , i , timecount )
	...
	np.savetxt("data.csv", populatedData, delimiter=",")
